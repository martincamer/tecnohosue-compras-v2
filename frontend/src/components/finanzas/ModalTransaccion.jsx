...
const ModalTransaccion = ({ isOpen, onClose, type, source }) => {
  const { crearTransaccionBanco, crearTransaccionCaja, cajas, sucursales } =
    useCajaBanco();
    ...
    <Modal>
      <ModalContent>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          {source === "CAJA" && type === "TRANSFERENCIA" && (
            <FormGroup>
              <Label>Seleccionar Caja de Destino</Label>
              <Select
                name="targetCashId"
                value={formData.targetCashId}
                onChange={handleChange}
                required
              >
