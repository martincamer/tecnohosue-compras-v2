...
const FormularioFactura = ({ clienteId, onClose, factura = null }) => {
  ...
  // Productos predefinidos con categorías
  const PRODUCTOS_PREDEFINIDOS = [
    ...
    {
      _id: 'CUOTAS_VIVIENDA',
      name: 'CUOTAS VIVIENDA',
      description: 'CUOTAS VIVIENDA',
      price: 0,
      category: 'CUOTA'
    },
    {
      _id: 'VIVIENDA_CONTADO',
      name: 'VIVIENDA CONTADO',
      description: 'VIVIENDA CONTADO',
      price: 0,
      category: 'VENTA'
    },
    {
  ...
  useEffect(() => {
    // Ya no necesitamos getProductos()
  }, []);
  ...
  const handleProductChange = (index, productId) => {
    const producto = PRODUCTOS_PREDEFINIDOS.find((p) => p._id === productId);
    if (producto) {
      setValue(`items.${index}.description`, producto.description);
      setValue(`items.${index}.unitPrice`, producto.price);
      setValue(`items.${index}.taxRate`, 21);
      setValue(`items.${index}.category`, producto.category);
    }
  };
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        ...
                        {PRODUCTOS_PREDEFINIDOS.map((producto) => (
                          <option
