...
const GarantiasAnexoPDF = ({ cliente }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          Sistema de Viviendas Tecnohogar se reserva al derecho de rechazar las
          garantías que presentadas, a su solo criterio, no tuvieran las
...
export default GarantiasAnexoPDF;
